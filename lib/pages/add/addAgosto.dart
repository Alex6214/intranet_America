...
class AddAgosto extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddAgosto(this.fecha, this.sede, this.nombres);

  @override
  _AddAgostoState createState() => _AddAgostoState();
}

class _AddAgostoState extends State<AddAgosto> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventAgosto =
        FirebaseFirestore.instance.collection('agosto');
    Future<void> addAgosto() {
      return eventAgosto.add({
