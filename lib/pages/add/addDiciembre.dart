...
class AddDiciembre extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddDiciembre(this.fecha, this.nombres, this.sede);

  @override
  _AddDiciembreState createState() => _AddDiciembreState();
}

class _AddDiciembreState extends State<AddDiciembre> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventDiciembre =
        FirebaseFirestore.instance.collection('diciembre');
    Future<void> addDiciembre() {
      return eventDiciembre.add({
