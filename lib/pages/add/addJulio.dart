...
class AddJulio extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddJulio(this.fecha, this.nombres, this.sede);

  @override
  _AddJulioState createState() => _AddJulioState();
}

class _AddJulioState extends State<AddJulio> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventJulio =
        FirebaseFirestore.instance.collection('julio');
    Future<void> addJulio() {
      return eventJulio.add({
