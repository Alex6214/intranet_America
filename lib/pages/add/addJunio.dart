...
class AddJunio extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddJunio(this.fecha, this.sede, this.nombres);

  @override
  _AddJunioState createState() => _AddJunioState();
}

class _AddJunioState extends State<AddJunio> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventJunio =
        FirebaseFirestore.instance.collection('junio');
    Future<void> addJunio() {
      return eventJunio.add({
