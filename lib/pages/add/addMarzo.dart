...
class AddMarzo extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddMarzo(this.fecha, this.sede, this.nombres);

  @override
  _AddMarzoState createState() => _AddMarzoState();
}

class _AddMarzoState extends State<AddMarzo> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventMarzo =
        FirebaseFirestore.instance.collection('marzo');
    Future<void> addMarzo() {
      return eventMarzo.add({
