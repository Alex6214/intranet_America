...
class AddNoviembre extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddNoviembre(this.fecha, this.sede, this.nombres);

  @override
  _AddNoviembreState createState() => _AddNoviembreState();
}

class _AddNoviembreState extends State<AddNoviembre> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventNoviembre =
        FirebaseFirestore.instance.collection('noviembre');
    Future<void> addNoviembre() {
      return eventNoviembre.add({
