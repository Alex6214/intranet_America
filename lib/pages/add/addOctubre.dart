...
class AddOctubre extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddOctubre(this.fecha, this.sede, this.nombres);

  @override
  _AddOctubreState createState() => _AddOctubreState();
}

class _AddOctubreState extends State<AddOctubre> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventOctubre =
        FirebaseFirestore.instance.collection('octubre');
    Future<void> addOctubre() {
      return eventOctubre.add({
