...
class AddSetiembre extends StatefulWidget {
  final String fecha;
  final String sede;
  final String nombres;

  AddSetiembre(this.fecha, this.sede, this.nombres);

  @override
  _AddSetiembreState createState() => _AddSetiembreState();
}

class _AddSetiembreState extends State<AddSetiembre> {
  ...
  Widget build(BuildContext context) {
    CollectionReference eventSetiembre =
        FirebaseFirestore.instance.collection('setiembre');
    Future<void> addSetiembre() {
      return eventSetiembre.add({
